...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private boolean mSurfaceExist = true;
...
//my code
        int maxAllowedWidth = (mMaxWidth != MAX_UNSPECIFIED && mMaxWidth < maxWidth)? mMaxWidth : maxWidth;
        int maxAllowedHeight = (mMaxHeight != MAX_UNSPECIFIED && mMaxHeight < maxHeight)? mMaxHeight : maxHeight;
//end my code

        Log.d(TAG, "MaxAll W: " + maxAllowedWidth);
        Log.d(TAG, "MaxAll H: " + maxAllowedHeight);
