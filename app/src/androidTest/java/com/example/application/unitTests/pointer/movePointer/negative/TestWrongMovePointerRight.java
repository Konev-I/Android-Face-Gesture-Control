...
public class TestWrongMovePointerRight {
    ...
    /**
     * Тест проверяет что указатель не перемещается, если он находится на границе экрана справа
     * @throws IOException
     */
    @Test
    public void testWrongMovePointerRight() throws IOException {
        ...
        testingPointer.movePointer(POINT_MOVE_RIGHT);
        assertAll(
                () -> assertEquals(SCREEN_WIDTH, testingPointer.getPosX()),
