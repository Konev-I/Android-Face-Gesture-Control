...
public class TestPointerEyesActionSwipe {
    private static final int SCREEN_WIDTH = 1000;
    private static final int SCREEN_HEIGHT = 1000;
    private static final Rect LEFT_EYE = new Rect(100, 100, 10, 10);
    private static final Rect RIGHT_EYE = new Rect(100, 1000, 10, 10);
    ...
    /**
     * Тест проверяет работу метода eyesAction при передаче параметров для свайпа
     * @throws IOException
     */
    @Test
    public void testPointerEyesActionSwipe() throws IOException {
