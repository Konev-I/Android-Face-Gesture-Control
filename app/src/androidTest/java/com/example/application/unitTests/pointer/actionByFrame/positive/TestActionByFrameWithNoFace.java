...
public class TestActionByFrameWithNoFace {
    ...
    /**
     * Тест проверяет работу метода actionByFrame при передаче кадра без лица
     * @throws IOException
     */
    @Test
    public void testActionByFrameWithNoFace() throws IOException {
