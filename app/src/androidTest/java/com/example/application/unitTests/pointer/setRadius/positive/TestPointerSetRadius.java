package com.example.application.unitTests.pointer.setRadius.positive;
...
public class TestPointerSetRadius {
    ...
    /**
     * Тест проверяет метод установки корректного значения размера слепой зоны
     * @throws IOException
     */
    @Test
    public void testPointerSetRadius() throws IOException {
        ...
        assertEquals(CUSTOM_RADIUS, testingPointer.getRadius());
    }
}
