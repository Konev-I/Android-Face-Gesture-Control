package com.example.application.unitTests.pointer.getPosX;
...
public class TestPointerGetPosX {
    ...
    /**
     * Тест проверяет метод получения координаты X указателя
     * @throws IOException
     */
    @Test
    public void testPointerGetPosX() throws IOException {
