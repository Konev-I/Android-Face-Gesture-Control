package com.example.application.unitTests.objectDetection.eyesPos.positive;
...
public class TestObjectDetectionEyesPosRightFirst {
     ...
     */
    @Test
    public void testObjectDetectionEyesPosRightFirst() throws IOException {
        Context appContext = InstrumentationRegistry.getInstrumentation().getTargetContext();
        ObjectDetection testingDetector = new ObjectDetection(appContext);

        List<Rect> eyes = testingDetector.eyesPos(RIGHT_EYE, LEFT_EYE);
        assertAll(
