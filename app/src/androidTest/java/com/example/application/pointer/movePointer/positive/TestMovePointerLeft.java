...
public class TestMovePointerLeft {
    ...
    /**
     * Тест проверяет перемещение указателя влево
     * @throws IOException
     */
    @Test
    public void testMovePointerLeft() throws IOException {
        ...
        testingPointer.movePointer(POINT_LEFT);
        assertAll(
